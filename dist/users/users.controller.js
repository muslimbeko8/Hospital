...
const login_in_user_dto_1 = require("./dto/login_in.user.dto");
...
function fileFilter(req, file, callback) {
    ...
    if (allowedTypes.includes(file.mimetype)) {
        ...
        callback(new common_1.BadRequestException('Faqat rasm fayllari yuklanishi mumkin'), false);
    }
}
let UsersController = class UsersController {
    ...
    async uploadFile(file, createUserDto) {
...
__decorate([
    (0, role_decorator_1.Roles)(create_user_dto_1.UserRole.ADMIN, create_user_dto_1.UserRole.SUPERADMIN),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [login_in_user_dto_1.LongInUserDto]),
    __metadata("design:returntype", void 0)
